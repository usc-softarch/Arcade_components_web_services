...
router.post('/prune',async(req, res) => {
    ...
    var command=['prune','--input','/tmp/'+req.body.inputFile,'--output', '/tmp/'+ req.body.outputFile,
    ...
    // var command=['prune','--input',req.body.inputFile,'--output', req.body.outputFile,
                    // '--prefix-code', req.body.prefixCode,'--training-portion',req.body.trainingPortion,'--validation-portion',req.body.validationPortion,
                    // '--random-seed', req.body.randomSeed,'--prune-infogain', req.body.pruneInfogain,'--prune-count', req.body.pruneCount,
    ...
    childProcess.on('exit', function (code, signal) {
        console.log('child process exited with ' +
                    ...
                    res.status(200).json('Generated new Mallet Prune output file at: /tmp/' + req.body.outputFile)
      }); 
});
