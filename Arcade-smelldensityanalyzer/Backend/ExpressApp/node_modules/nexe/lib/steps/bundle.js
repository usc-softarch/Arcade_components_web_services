        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 9:
                    ...
                    return [4 /*yield*/, resolve_dependencies_1.default.apply(void 0, __spreadArrays([input], Object.keys(compiler.bundle.index).filter(function (x) { return x.endsWith('.js'); }), [{ cwd: cwd, expand: 'variable', loadContent: false }]))];
                case 10:
