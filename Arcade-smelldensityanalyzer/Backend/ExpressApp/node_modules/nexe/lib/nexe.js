        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, app_builder_1.compose(clean_1.default, resource_1.default, cli_1.default, bundle_1.default, shim_1.default, download_1.default, options.build ? __spreadArrays([artifacts_1.default], patches_1.default, options.patches) : [], options.plugins)(compiler)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
