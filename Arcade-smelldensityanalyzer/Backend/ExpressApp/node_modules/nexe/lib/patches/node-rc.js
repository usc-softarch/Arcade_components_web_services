...
function nodeRc(compiler, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = compiler.options.rc;
                    if (!options) {
                        return [2 /*return*/, next()];
                    }
                    return [4 /*yield*/, compiler.readFileAsync('src/res/node.rc')];
                case 1:
                    file = _a.sent();
                    Object.keys(options).forEach(function (key) {
                        var value = options[key];
                        var isVar = /^[A-Z_]+$/.test(value);
                        value = isVar ? value : "\"" + value + "\"";
                        file.contents = file.contents.replace(new RegExp("VALUE \"" + key + "\",.*"), "VALUE \"" + key + "\", " + value);
                    });
                    ['PRODUCTVERSION', 'FILEVERSION'].forEach(function (x) {
                        if (options[x]) {
