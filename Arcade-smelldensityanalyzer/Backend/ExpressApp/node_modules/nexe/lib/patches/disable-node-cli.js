        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, compiler.replaceInFileAsync('src/node.cc', /(?<!int )ProcessGlobalArgs\(argv[^;]*;/gm, '0;/*$&*/')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 9];
                case 2:
                    if (!util_1.semverGt(compiler.target.version, '10.9')) return [3 /*break*/, 4];
                    return [4 /*yield*/, compiler.replaceInFileAsync('src/node.cc', /(?<!void )ProcessArgv\(argv/g, '//$&')];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 9];
                case 4:
